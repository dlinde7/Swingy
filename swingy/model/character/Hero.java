...
public class Hero extends Character {
    ...
    private void levelUp() {
        level++;
        if ("warrior".equalsIgnoreCase(heroClass)){
            hitPoints += 20;
            attack += 20;
            defense += 10 ;
        } else if ("shaman".equalsIgnoreCase(heroClass)){
            hitPoints += 10;
            attack += 25;
            defense += 15;
        } else if ("priest".equalsIgnoreCase(heroClass)){
            hitPoints += 20;
            attack += 15;
            defense += 15 ;
        } else if ("paladin".equalsIgnoreCase(heroClass)){
            hitPoints += 20;
            attack += 10;
            defense += 20 ;
        } else if ("mage".equalsIgnoreCase(heroClass)){
            hitPoints += 10;
            attack += 30;
            defense += 10 ;
        } else if ("ranger".equalsIgnoreCase(heroClass)){
            hitPoints += 25;
            attack += 15;
            defense += 10 ;
        }
